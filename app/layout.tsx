...
export default function RootLayout({
    ...
    <header className="text-center border border-white/20 bg-black bg-opacity-90 backdrop-blur-lg shadow-xl p-2 my-4 rounded-lg ">
      <div className="flex flex-row">
        ...
        <div className="mx-auto my-auto">
          <Link href="/">
            <h1 className="text-xl font-bold text-white">Mohd Abdul Quadeer</h1>
          </Link>
            <p className="text-white">Exploring tech with Algorithms, Web Dev, ML, and Linux🐧</p>
        </div>
      </div>
    </header>
  );
  ...
  const footer = (
    <footer>
      <div className="text-center  bg-indigo-300 p-2 my-2 rounded-md">
        ...
        <div className="flex items-center justify-center">
          <div className="flex flex-row gap-3">
            ...
            <Link href="https://github.com/quadeer2003">
              {/* Github  */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-7 w-7"
